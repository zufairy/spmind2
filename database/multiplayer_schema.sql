-- Multiplayer Game Database Schema
-- This extends the existing database with multiplayer functionality
...
('sunny_park', 'Sunny Park', 'park', '#87CEEB', 20, false),
('cozy_cafe', 'Cozy Cafe', 'cafe', '#D2B48C', 15, false),
('chilly_rooftop', 'Chilly Rooftop', 'arcade', '#9370DB', 10, false)
